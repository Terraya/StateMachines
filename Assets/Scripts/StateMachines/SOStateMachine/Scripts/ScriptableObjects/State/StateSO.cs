...
namespace TDSGamer.SOStateMachine
{
    ...
    public class StateSO : ScriptableObject
    {
        ...
        /// </summary>
        internal State GetState(SOStateMachine stateMachine, Dictionary<ScriptableObject, object> createdInstances)
        {
        ...
        private static StateAction[] GetActions(StateActionSO[] scriptableActions,
            SOStateMachine stateMachine, Dictionary<ScriptableObject, object> createdInstances)
        {
