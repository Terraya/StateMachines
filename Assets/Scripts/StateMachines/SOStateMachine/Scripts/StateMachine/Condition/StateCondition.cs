namespace TDSGamer.SOStateMachine
{
	...
	public abstract class Condition : IStateComponent
	{
		...
		public virtual void Awake(SOStateMachine stateMachine) { }
	...
	{
		internal readonly SOStateMachine _stateMachine;
		internal readonly Condition _condition;
		internal readonly bool _expectedResult;

		public StateCondition(SOStateMachine stateMachine, Condition condition, bool expectedResult)
		{
